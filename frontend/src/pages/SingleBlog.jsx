...
const SingleBlog = (props) => {
  ...
  console.log(getBlog?.[0].comments.map((c, i) => c.createdAt).sort());
        ...
        <div className=" container">
          <div className=" row">
              ...
              <div className="col-lg-12 col-md-12 col-sm-6 mb-1 mx-auto">
                <div className="mt-4 d-flex flex-column mx-auto justify-content-center align-items-center">
                  <div className=" w-75 ">
                    ...
                    <p className="poppin" style={{ marginLeft: "2px" }}>
                      by{" "}
                    ...
                    <p className="poppin" style={{ color: "grey" }}>
                      ...
                      Debitis iusto eos at eaque eligendi quam, numquam
                      voluptate maxime perspiciatis accusantium? Lorem ipsum
                ...
                <div className=" col-lg-12 col-sm-6 col-md-6 w-75 mx-auto justify-content-center align-items-start">
                  <div className=" w-100 mx-auto ">
                    <div className=" poppins my-2 align-self-start">
                      Share you Thoughts
                    </div>
            ...
            /> */}
                  ...
                  {!getBlog?.[0]?.comments.length > 0 && (
                    <div className="mt-3 ms-1 poppin">
